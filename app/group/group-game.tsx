...
export default function GroupGameScreen() {
  ...
  // Auto-route to voting screen for Who's More Likely after reveal to avoid cramped buttons
  useEffect(() => {
    if (isWhosMoreLikely && revealed && !gameFinished) {
      router.replace('/group/vote');
    }
  }, [isWhosMoreLikely, revealed, gameFinished, router]);
